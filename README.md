...
# 👋 Hola, soy Freddy Otavalo

Desarrollador Jr con interés en **Node.js, Flutter, Python y análisis de datos**.  
Me gusta crear aplicaciones útiles y estoy en constante aprendizaje.
